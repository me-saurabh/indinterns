...
<?php
	echo "\t<div class='postbox-container' style='width:" . esc_attr( $this->args['column_widths'][0] ) . "%'>\n";
	do_meta_boxes( $this->pagehook, 'normal', '' );

	echo "\t</div><div class='postbox-container' style='width:" . esc_attr( $hide2 ) . esc_attr( $this->args['column_widths'][1] ) . "%'>\n";
	do_meta_boxes( $this->pagehook, 'side', '' );

	echo "\t</div><div class='postbox-container' style='width:" . esc_attr( $hide3 ) . esc_attr( $this->args['column_widths'][2] ) . "%'>\n";
	do_meta_boxes( $this->pagehook, 'column3', '' );

	echo "\t</div><div class='postbox-container' style='width:" . esc_attr( $hide4 ) . esc_attr( $this->args['column_widths'][3] ) . "%'>\n";
...
<?php
		...
		wp_add_inline_script( 'postbox', $html );
?>
