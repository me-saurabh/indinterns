...
global $post;
?>
<div id="favorite-property-<?php the_ID(); ?>" <?php job_listing_class('job-list favorite-item'); ?> data-longitude="<?php echo esc_attr( $post->geolocation_lat ); ?>" data-latitude="<?php echo esc_attr( $post->geolocation_long ); ?>">
	...
	<div class="job-content-wrapper media">
		<div class="media-left media-middle">
			<div class="action-favorite">
				...
				<a class="apus-favorite-remove" href="" data-id="<?php the_ID(); ?>"><i class="fa fa-close"></i></a>
			</div>
		</div>
