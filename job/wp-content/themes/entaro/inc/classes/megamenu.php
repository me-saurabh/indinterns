...
if ( !class_exists("Entaro_Nav_Menu") ) {
    class Entaro_Nav_Menu extends Walker_Nav_Menu {
       ...
       /**
        ...
        public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
            ...
            $item_output .= $args->has_children || $apus_mega_profile ? ' <b class="fa fa-angle-down text-theme"></b></a>' : '</a>';
